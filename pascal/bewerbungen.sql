...
CREATE TRIGGER "AI_BEWERBUNGEN" AFTER INSERT ON "BEWERBUNGEN" BEGIN  INSERT INTO LOG(DATUM, BEWERBUNG, TYP, BESCHREIBUNG) SELECT NEW.DATUM, NEW.ID, "VERSAND", "BEWERBUNGSUNTERLAGEN VERSENDET" END;

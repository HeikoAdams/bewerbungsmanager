CREATE TABLE "BEWERBUNGEN"(ID INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, DATUM DATETIME NOT NULL, NAME VARCHAR(255) NOT NULL, MAIL VARCHAR(255), JOBTITEL VARCHAR(255) NOT NULL, REFNR VARCHAR(255), TYP INT NOT NULL, FEEDBACK INT NOT NULL, RESULT INT NOT NULL, WVL DATETIME NOT NULL, NOTES VARCHAR(8000), VERMITTLER BOOLEAN);
